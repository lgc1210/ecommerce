...
import OrderTabSkeleton from "./skeleton";
...
const OrdersTab = ({ initialSelectedOrderId = null }: OrdersTabProps) => {
	...
	if (selectedOrderId !== null) return <OrderDetail orderId={selectedOrderId} onBack={() => selectOrder(null)} />;

	if (isLoading) return <OrderTabSkeleton />;
