...
const STEPS: { status: OrderStatus; label: string; icon: typeof ClockIcon }[] = [
	...
	{ status: ORDER_STATUS.processing, label: "Đang xử lý", icon: BoxIcon },
	{ status: ORDER_STATUS.shipped, label: "Đang giao", icon: TruckIcon },
	{ status: ORDER_STATUS.delivered, label: "Đã giao", icon: CheckIcon },
];
