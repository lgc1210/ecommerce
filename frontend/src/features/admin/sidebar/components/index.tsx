...
const Sidebar = ({ open, onClose, collapsed, onToggleCollapse }: SidebarProps) => {
	...
	return (
		<>
			...
			<aside
				className={`fixed inset-y-0 left-0 z-50! flex w-64 shrink-0 flex-col bg-ink text-cream transition-[transform,width] duration-200 ease-out lg:static lg:z-auto lg:translate-x-0 ${
