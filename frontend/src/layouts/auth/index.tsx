	...
	return (
		<div className='flex min-h-screen items-center justify-center bg-cream-soft px-4 py-16'>
			<div className='w-full max-w-md rounded-3xl border border-border bg-surface p-8 shadow-sm shadow-ink/5'>
				<Link to={paths.client.home} className='flex items-center justify-center gap-2' viewTransition>
				...
				<p className='mt-6 text-center text-sm text-muted'>
					{footerText}{" "}
					<Link to={footerLinkTo} className='font-semibold text-primary-dark hover:underline' viewTransition>
						{footerLinkText}
					</Link>
				</p>
			</div>
