	...
	return (
		<div className={`group relative inline-flex ${className}`}>
			...
			<div
				...
				<div
					className={`translate-y-2 overflow-hidden rounded-xl border border-border bg-surface shadow-xl transition-transform duration-200 group-hover:translate-y-0 ${contentClassName}`}>
					{children}
				</div>
			</div>
		</div>
