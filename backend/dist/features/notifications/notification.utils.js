...
export function buildOrderPlacedNotification(userId, orderId, orderNumber) {
    return {
        userId,
        type: "order",
...
export function buildOrderStatusChangedNotification(userId, orderId, orderNumber, status) {
    return {
        userId,
        type: "order",
...
export function buildPaymentCompletedNotification(userId, orderId, orderNumber) {
    return {
        userId,
        type: "payment",
...
export function buildPaymentFailedNotification(userId, orderId, orderNumber) {
    return {
        userId,
        type: "payment",
...
export function buildPaymentRefundedNotification(userId, orderId, orderNumber) {
    return {
        userId,
        type: "payment",
...
export function buildReviewRepliedNotification(userId, productSlug, reviewId) {
    return {
        userId,
        type: "review",
 ...
 */
export function buildAdminNewOrderContent(orderId, orderNumber, totalAmount) {
    return {
        type: "order",
        title: "Đơn hàng mới",
 ...
 */
export function buildAdminLowStockContent(skuId, skuLabel, productId, productName, stockQuantity) {
    return {
        type: "stock",
        title: "Tồn kho thấp",
...
export function buildAdminPaymentFailedContent(orderId, orderNumber) {
    return {
        type: "payment",
 ...
 */
export function buildAdminNewReviewContent(reviewId, productName, rating) {
    return {
        type: "review",
 ...
 */
export function buildAdminSystemAlertContent(title, message) {
...
export function buildAdminNewContactContent(contactId, name, subject) {
    return {
        type: "contact",
        title: "Liên hệ mới",
