...
export const permissionSeed = async () => {
    ...
    await rbacService.createPermission("conversation", "manage", "Xem toàn bộ hội thoại hỗ trợ khách hàng (shared inbox), nhận xử lý, đổi trạng thái, trả lời bất kỳ hội thoại nào.");
    await rbacService.createPermission("conversation", "create", "Tạo/gửi tin nhắn trong hội thoại hỗ trợ của chính mình.");
