...
export const listAddresses = async (req, res, next) => {
    try {
        const result = await userAddressService.listAddresses(req.query);
...
export const listAddressesByUser = async (req, res, next) => {
    try {
...
// Admin: mutation
// ==========================================
export const adminUpdateAddress = async (req, res, next) => {
    try {
        const addressId = Number(req.params.addressId);
...
export const adminDeleteAddress = async (req, res, next) => {
    try {
        const addressId = Number(req.params.addressId);
...
//# sourceMappingURL=user_address.controller.js.map