...
class UserAddressService {
    ...
    async listAddresses(params) {
        ...
        if (params.province)
            where.provinceName = { contains: params.province };
        if (params.search) {
    ...
    async listAddressesByUser(userId) {
    ...
    async adminDeleteAddress(addressId) {
        const address = await this.getAddressOrThrow(addressId);
        try {
    ...
    // Helpers
    // ==========================================
    async getAddressOrThrow(addressId) {
...
//# sourceMappingURL=user_address.service.js.map