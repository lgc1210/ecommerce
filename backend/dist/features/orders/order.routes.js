...
import { checkout, previewShippingFee, buyNow, previewBuyNowShippingFee, listOwnOrders, getOwnOrderById, cancelOwnOrder, listOrdersAdmin, getOrderById, updateOrderStatus, receiveGhnWebhook, } from "./order.controller.js";
import { validate } from "../../middlewares/validate.js";
import { CreateOrderSchema, PreviewShippingFeeSchema, BuyNowSchema, PreviewBuyNowShippingFeeSchema, ListOwnOrdersQuerySchema, OrderIdParamSchema, ListOrdersAdminQuerySchema, UpdateOrderStatusSchema, GhnWebhookSchema, } from "./order.validation.js";
import { authenticateJWT } from "../../middlewares/authenticate.js";
import { requirePermission } from "../../middlewares/rbac.js";
const router = Router();
// ==========================================
// Webhook (KHÔNG có auth — GHN gọi trực tiếp server-to-server bằng callback URL cấu hình sẵn ở
// trang quản lý shop GHN, không phải người dùng đăng nhập nên không thể yêu cầu JWT ở đây)
// ==========================================
router.post("/webhooks/ghn", validate(GhnWebhookSchema), receiveGhnWebhook);
// ==========================================
