...
export const getProductBySlug = async (req, res, next) => {
    try {
        const product = await productService.getProductBySlug(req.params.slug, { publicOnly: true });
...
export const updateSkuStock = async (req, res, next) => {
    try {
        const productId = Number(req.params.id);
        const skuId = Number(req.params.skuId);
...
// ==========================================
export const addSkuImage = async (req, res, next) => {
    try {
        const productId = Number(req.params.id);
        const skuId = Number(req.params.skuId);
...
export const updateSkuImage = async (req, res, next) => {
    try {
        const productId = Number(req.params.id);
        const skuId = Number(req.params.skuId);
...
export const deleteSkuImage = async (req, res, next) => {
    try {
        const productId = Number(req.params.id);
        const skuId = Number(req.params.skuId);
        const imageId = Number(req.params.imageId);
