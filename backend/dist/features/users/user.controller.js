...
// ==========================================
export const listOwnAddresses = async (req, res, next) => {
    try {
...
export const createOwnAddress = async (req, res, next) => {
    try {
...
export const updateOwnAddress = async (req, res, next) => {
    try {
...
export const setDefaultOwnAddress = async (req, res, next) => {
    try {
        const addressId = Number(req.params.addressId);
...
export const deleteOwnAddress = async (req, res, next) => {
    try {
        const addressId = Number(req.params.addressId);
