...
class UserService {
    ...
    // ==========================================
    async listOwnAddresses(userId) {
        return prisma.userAddress.findMany({
            where: { userId },
            orderBy: [{ isDefault: "desc" }, { createdAt: "desc" }],
        });
    }
    async createOwnAddress(userId, data) {
    ...
    async updateOwnAddress(userId, addressId, data) {
    ...
    async setDefaultOwnAddress(userId, addressId) {
    ...
    async deleteOwnAddress(userId, addressId) {
        const address = await this.getOwnedAddressOrThrow(userId, addressId);
        try {
    ...
    async getOwnedAddressOrThrow(userId, addressId) {
    ...
    async listUsers(params) {
        ...
        if (params.roleId)
            where.roleId = Number(params.roleId);
