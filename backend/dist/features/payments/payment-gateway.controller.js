...
export const handleVnpayReturn = async (req, res) => {
    const result = await paymentGatewayService.handleReturn(PaymentMethod.vnpay, req.query);
...
export const handleVnpayIpn = async (req, res) => {
    const result = await paymentGatewayService.handleIpn(PaymentMethod.vnpay, req.query);
    if (!result.ok) {
...
export const handleZalopayCallback = async (req, res) => {
    const result = await paymentGatewayService.handleIpn(PaymentMethod.zalopay, req.body);
    if (!result.ok) {
