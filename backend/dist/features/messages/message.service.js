...
class MessageService {
     ...
     */
    async assertCanAccessConversation(user, conversationId) {
    ...
    async sendMessage(conversationId, senderId, input) {
        ...
        if (conversation.status !== ConversationStatus.open) {
            throw new Error(`BadRequest: Hội thoại này đã ở trạng thái "${conversation.status}", không thể gửi thêm tin nhắn.`);
        }
