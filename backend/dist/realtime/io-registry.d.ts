 ...
 */
export declare const STAFF_SUPPORT_ROOM = "staff:support";
export declare const conversationRoom: (conversationId: number) => string;
...
//# sourceMappingURL=io-registry.d.ts.map