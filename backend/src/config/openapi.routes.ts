...
export const routeManifest: RouteMeta[] = [
	...
	{ method: "post", path: "/orders/buy-now", tag: "Orders", summary: "Mua ngay (đặt hàng thẳng đúng 1 SKU, không qua giỏ hàng)", auth: true, permission: "order:create", schema: BuyNowSchema },
	{ method: "post", path: "/orders/buy-now/shipping-fee", tag: "Orders", summary: "Xem trước phí vận chuyển GHN cho luồng mua ngay (1 SKU)", auth: true, permission: "order:create", schema: PreviewBuyNowShippingFeeSchema },
