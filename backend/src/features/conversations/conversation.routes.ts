...
import {
	...
	getOwnCurrentConversation,
	getOwnConversation,
	markOwnConversationRead,
...
import {
	...
	MarkOwnConversationReadSchema,
	MarkStaffConversationReadSchema,
...
router.patch(
	...
	authenticateJWT,
	requirePermission("conversation:create"),
	validate(MarkOwnConversationReadSchema),
	markOwnConversationRead,
);
...
router.get(
	"/",
	authenticateJWT,
	requirePermission("conversation:manage"),
...
router.patch(
	...
	authenticateJWT,
	requirePermission("conversation:manage"),
	validate(MarkStaffConversationReadSchema),
	markStaffConversationRead,
);
