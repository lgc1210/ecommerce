...
import { listCategories, getFeaturedCategories, getCategoryBySlug, getCategoryById, createCategory, updateCategory, deleteCategory } from "./category.controller.js";
import { validate } from "../../middlewares/validate.js";
import { ListCategoriesQuerySchema, FeaturedCategoriesQuerySchema, CategorySlugParamSchema, CategoryIdParamSchema, CreateCategorySchema, UpdateCategorySchema } from "./category.validation.js";
...
router.get("/featured", validate(FeaturedCategoriesQuerySchema), getFeaturedCategories);
