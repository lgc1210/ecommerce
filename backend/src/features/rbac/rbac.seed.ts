...
export const permissionSeed = async () => {
	...
	await rbacService.createPermission(
		"user",
		"read",
		"View customer listings, ban/unban users, update system staff accounts.",
	);
	await rbacService.createPermission(
		"user",
		"write",
	...
	await rbacService.createPermission(
		"rbac",
		"manage",
		"Create new roles or modify permissions assigned to standard staff.",
	);
	await rbacService.createPermission(
		"catalog",
		"read",
		"Browse active products, categories, and SKUs (Public permission).",
	);
	await rbacService.createPermission(
		"catalog",
		"write",
		"Create, update, delete, or deactivate products, categories, and variants.",
	);
	await rbacService.createPermission(
		"inventory",
		"update",
	...
	await rbacService.createPermission(
		"order",
		"update",
		"Update order processing states (e.g., changing status from pending to shipped).",
	);
	await rbacService.createPermission(
		"coupon",
		"manage",
	...
	await rbacService.createPermission(
		"review",
		"update",
		"Delete spam comments or inappropriate text entries from the public site.",
	);
	await rbacService.createPermission(
		"contact",
		"manage",
	...
	await rbacService.createPermission(
		"payment",
		"read",
		"View payment records and transaction statuses for any order (Admin).",
	);
	await rbacService.createPermission(
		"payment",
		"manage",
		"Update payment status manually (e.g., mark as paid, refunded, failed).",
	);
	await rbacService.createPermission(
		"dashboard",
		"read",
		"View admin dashboard overview, revenue charts, and system statistics.",
	);
	await rbacService.createPermission(
		"notification",
		"broadcast",
	...
	await rbacService.createPermission(
		"conversation",
		"manage",
		"Xem toàn bộ hội thoại hỗ trợ khách hàng (shared inbox), nhận xử lý, đổi trạng thái, trả lời bất kỳ hội thoại nào.",
	);
	await rbacService.createPermission(
		"conversation",
		"create",
